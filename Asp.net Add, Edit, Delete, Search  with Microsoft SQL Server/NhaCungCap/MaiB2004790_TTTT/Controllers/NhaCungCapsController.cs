...
namespace MaiB2004790_TTTT.Controllers
{
    public class NhaCungCapsController : Controller
    {
        ...
        public NhaCungCapsController(MaiB2004790ttttContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            {
                return View(await _context.NhaCungCaps.Where(m => m.TenNhaCungCap.Contains(searchString)).ToListAsync());
            }
            else
            {
        ...
        public async Task<IActionResult> Create([Bind("Id,MaSoThue,TenNhaCungCap,DiaChi,Sdt,Email,SoTk")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MaSoThue,TenNhaCungCap,DiaChi,Sdt,Email,SoTk")] NhaCungCap nhaCungCap)
        {
            if (id != nhaCungCap.Id)
            {
                return NotFound();
